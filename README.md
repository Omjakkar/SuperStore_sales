# SuperStore_sales
An interactive sales analytics dashboard built on the Sample Superstore dataset, analyzing 10,000+ orders across regions, categories, and time to uncover revenue trends and profitability insights.
